...
var MAP_GHOST_TOWN = new Map("mvm_ghost_town");
...
MAP_GHOST_TOWN.addSpawns("spawnbot spawnbot_mission_sniper spawnbot_mission_spy spawnbot_giant");
...
MAP_GHOST_TOWN.addTags("nav_prefer_flank_right nav_prefer_flank_left special_main_right special_main_left");
...
MAP_GHOST_TOWN.addTankPaths("boss_path_1");
...
MAP_GHOST_TOWN.setStartWaveOutput("wave_start_relay").setStartWaveOutput("wave_start_relay_666", true).setDoneOutput("wave_finished_relay");
...
MapList["mvm_ghost_town"] = MAP_GHOST_TOWN;
...
MAP_GHOST_TOWN.addPopulation("Caliginous Caper", "mvm_ghost_town.xml");
